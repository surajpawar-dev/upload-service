...
import com.suraj.uploadplatform.common.properties.DocumentProcessingProperties;
...
import com.suraj.uploadplatform.service.UploadEventPublisher;
...
public class DocumentProcessingUploadEventPublisher implements UploadEventPublisher {
    ...
    public void publishUploadCompleted(FileDocument document) {
        ...
        log.info("Submitted uploaded PDF to document-processing-service fileId={} s3Key={}",
